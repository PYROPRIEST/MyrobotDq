class script(object):
    START_TXT = """Hello {},
My Name Is <a href=https://t.me/{}>{}</a>, Why are you here . I am only  For @Pirate_Cinemas_Group 😍"""
    HELP_TXT = """Hey {}
𝙷𝙴𝚁𝙴 𝙸𝚂 𝚃𝙷𝙴 𝙷𝙴𝙻𝙿 𝙵𝙾𝚁 𝙼𝚈 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂."""
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/clause07>This Perzon</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼 V2
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: AnyWhere
...
<b>DEVS:</b>
- <a href=https://t.me/clause07>Myself Deku...</a>"""
    MANUELFILTER_TXT = """Help: There is no manual Filters for You . This Bot is Only for @pirate_Cinemas_group """
    BUTTON_TXT = """Help: 🐖 Are you a Spammer ! """
    AUTOFILTER_TXT = """Help: Why are You looking for help, As I said this bot is not for you sire! """  
